...
describe('About You', function()
{
    it('E2E test', function()
    {
        ...
        cy.title().should('be.eq', 'Blugi damă | ABOUT YOU')
        results_page.selectItem()
        cy.title().should('be.eq', "ONLY Jeans 'Paola' pe Albastru Închis | ABOUT YOU")
        ...
        cy.title().should('be.eq', "Articolele din coșul tău de cumpărături ABOUT YOU")
